...
(
  ...
  always_comb
   begin
     hwpe_cfg_slave.gnt     = periph.gnt      ;
     hwpe_cfg_slave.r_rdata = periph.r_data   ;
     hwpe_cfg_slave.r_valid = periph.r_valid  ;
     hwpe_cfg_slave.r_id    = periph.r_id     ;
     hwpe_cfg_slave.r_opc   = 1'b0            ;
   end
