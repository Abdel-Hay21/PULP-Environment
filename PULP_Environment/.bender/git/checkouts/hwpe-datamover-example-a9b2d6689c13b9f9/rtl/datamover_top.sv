...
always_ff @(posedge clk_i or negedge rst_ni) begin
  if(!rst_ni)
    ...
    sample_cnt <= 0;
  else if((cs == DM_WORKING && data_in.valid && data_in.ready) || ( cs == DM_STARTING && data_in.valid && data_in.ready))
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  begin : fsm_ns_comb
    ...
    if(cs == DM_IDLE) begin
      if(slave_flags.start)
       ...
       if (data_in.valid && data_in.ready)
         ns = DM_WORKING;
        else
         ns = DM_STARTING;
    end
  ...
  begin : fsm_out_comb
    ...
    if(cs == DM_STARTING) begin
     ...
     if ((sample_cnt >= 1) && (sample_cnt< streamer_ctrl_cfg.data_in_source_ctrl.addressgen_ctrl.tot_len )) 
       valid_in = 1'b1 ;
      else
       valid_in = 1'b0 ;
