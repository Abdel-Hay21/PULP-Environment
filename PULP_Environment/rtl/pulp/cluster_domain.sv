...
`include "soc_bus_defines.sv" //Modify by Ali Mohamed
...
#(
    //CLUSTER PARAMETERS
    parameter int unsigned CLUSTER_ID = 0,  //Modify by Ali Mohamed
...
`endif    
    ...
    (
       ...
       // .base_addr_i                  ( 4'((32'h1000_0000 + CLUSTER_ID * `CLUSTER_TCDM_SIZE) >> 28) ), //Modify by Ali Mohamed
        .base_addr_i                  (  32'h1000_0000 + CLUSTER_ID * 32'h0040_0000  ),
        ...
        .eoc_o                        (                              ),
        .busy_o                       ( busy_o                       ),
        .cluster_id_i                 ( CLUSTER_ID[5:0]                    ),  //Modify by Ali Mohamed
