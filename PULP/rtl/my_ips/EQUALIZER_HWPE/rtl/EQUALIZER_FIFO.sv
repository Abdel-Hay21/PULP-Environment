...
module EQUALIZER_FIFO #(
  ...
  output logic   [31:0]                    in32            ,
  output logic                             valid_in        ,
  input  logic                             all_data_arrive ,
  output logic                             data_arrive     ,
  ...
  assign data_arrive = !fifo_data_in_empty;
  // fifo data_out
  fifo_v3 #(
    .DATA_WIDTH ( BW_ALIGNED ),
    .DEPTH      ( FIFO_DEPTH )
  ...
  always_comb 
  begin
    if(data_arrive == 1 && all_data_arrive == 1)
      empty_data_in = 0;
    else
      empty_data_in = 1;
  end
