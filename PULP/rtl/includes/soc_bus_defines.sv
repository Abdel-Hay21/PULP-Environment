...
//Modify Ali Mohamed
`define NB_SLAVE  (4 + `NB_CLUSTERS - 1)
`define NB_MASTER 4
`define NB_REGION 4

// MASTER PORT TO CLUSTER(4MB)
//`define CLUSTER_DATA_START_ADDR  32'h1000_0000
//`define CLUSTER_DATA_END_ADDR    32'h103F_FFFF
//Modify Ali Mohamed
// ========================================
// CLUSTER TCDM REGIONS (per cluster)
// ========================================

`define CLUSTER_TCDM_SIZE 32'h0040_0000   // 4MB per cluster

// Cluster 0
`define CLUSTER_0_TCDM_BASE 32'h1000_0000
`define CLUSTER_0_TCDM_END  (`CLUSTER_0_TCDM_BASE + `CLUSTER_TCDM_SIZE - 1)

// Cluster 1
`define CLUSTER_1_TCDM_BASE 32'h1040_0000
`define CLUSTER_1_TCDM_END  (`CLUSTER_1_TCDM_BASE + `CLUSTER_TCDM_SIZE - 1)
